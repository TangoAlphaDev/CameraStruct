...
// @TangoAlphaDev
// Define a struct to hold the camera mode and associated spec handle
USTRUCT(BlueprintType)
struct FAbilityCameraModeEntry
{
	GENERATED_BODY()
	...
	FAbilityCameraModeEntry()
		: CameraMode(nullptr)
	{}
	
	FAbilityCameraModeEntry(TSubclassOf<ULyraCameraMode> InCameraMode, const FGameplayAbilitySpecHandle& InSpecHandle)
		: CameraMode(InCameraMode), SpecHandle(InSpecHandle)
	{}
};
// @TangoAlphaDev
...
protected:
	...
	// @TangoAlphaDev
	// List of camera modes and their associated spec handles.
	UPROPERTY()
	TArray<FAbilityCameraModeEntry> AbilityCameraModeEntries;
	// @TangoAlphaDev
